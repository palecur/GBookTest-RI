...
RIME now supports loading data directly from Databricks Delta Lake directly, 
so you do not have to copy the file locally or to s3. You can configure
[Databricks Delta Lake using the UI.](/for_admins/how_to_guides/data-sources.md)
...
**In order to get the Databricks Delta Lake connection details -** 
