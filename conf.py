...
html_css_files = [
    'https://cdn.datatables.net/v/dt/dt-1.13.1/sb-1.4.0/datatables.min.css',
    'custom.css',
]

html_js_files = [
    'main.js',
    'https://cdn.datatables.net/v/dt/dt-1.13.1/sb-1.4.0/datatables.min.js',
]
...
stress_test_bio = (
    ...
    "to test.\n\nFor a full list of available stress tests, see the "
    "consolidated test bank in [RIME Overview](/getstarted/index.rst)."
)
